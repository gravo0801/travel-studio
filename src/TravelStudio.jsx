    ...
    <>
      ...
      {view === 'edit' && (
        <>
          ...
          <div
            style={{ border: `2px dashed ${T.border}`, borderRadius: 4, padding: '26px 16px', textAlign: 'center', background: T.soft, cursor: 'pointer', marginBottom: 14, fontFamily: T.S, fontSize: 13, color: T.sub, lineHeight: 1.6 }}
            onClick={() => fileRef.current?.click()}
            onDragOver={e => e.preventDefault()}
